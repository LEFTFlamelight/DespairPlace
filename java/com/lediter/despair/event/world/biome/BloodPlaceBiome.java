...
public class BloodPlaceBiome {
	...
	public static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-65485).setWaterColor(-10092544).setWaterFogColor(-3407872)
						.withSkyColor(-65485).withFoliageColor(-6750208).withGrassColor(-6750208).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.FLOWER.withConfiguration(Features.Configs.NORMAL_FLOWER_CONFIG)
								.withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityTypeRegister.BLOOD_VILLAGER_ENTITY.get(),
						5, 1, 1));
